...
DuckDB Retirement Cutover Ticket 02: these 10 tables carry no SEC content and
no MDM entity data -- they are the warehouse runtime's own operational
bookkeeping (checkpoints, leases, sync/parse/pipeline run audit rows, and the
gold publish manifest). They move to Snowflake's native
