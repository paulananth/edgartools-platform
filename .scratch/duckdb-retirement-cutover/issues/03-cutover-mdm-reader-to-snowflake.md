# 03 — Cut Over MDM's `ShardedSilverReader` to Snowflake
...
standard (wayfinder decision, not this ticket's own Ticket 07 below) — same
...
- [ ] `edgar_warehouse/silver_support/sharded_reader.py`'s DuckDB-backed
      ...
      [Ticket 10](10-duckdb-retirement-cleanup.md)'s final sweep — not
