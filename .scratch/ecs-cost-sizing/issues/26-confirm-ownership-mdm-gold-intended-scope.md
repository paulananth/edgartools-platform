...
Form 3/4/5 already in silver → persons + IS_INSIDER only (Ticket 24).
...
field states the same thing independently: *"Ticket 24 insider path:
...
Ticket 24 insider load is person + IS_INSIDER only (#262)"
...
all`."* (Note: this "Ticket 24" is a different, earlier workstream's
ticket — not this map's own Ticket 24 — distinct namespace, cited here
