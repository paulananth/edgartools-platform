...
Raised by [Decide and Capture the Protected Rollback Cohort](20-decide-and-capture-protected-rollback-cohort.md),
...
prior code cohort. Ticket 21 already ruled out the obvious pre-handoff
...
execution, and record the same evidence class Ticket 20 captured for the
