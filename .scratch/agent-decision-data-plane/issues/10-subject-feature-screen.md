...
- [ ] Screen lists only Decision Subject Universe members
- [ ] FY and interim vectors follow As-Of Decision Features rules (null ≠ zero; interim only when newer than FY)
- [ ] Coverage flags present on factor sections
- [ ] Results carry Decision Contract Version and Decision Watermark identity
- [ ] No market price / PE fields
