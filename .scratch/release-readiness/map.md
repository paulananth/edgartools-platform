...
7. [Investigate Apple Form 4 immutable-object content conflict](issues/87-immutable-object-conflict-apple-form4.md) — task, found live 2026-08-04: `targeted-resync --scope-type cik --scope-key 320193` hard-failed on accession `0000320193-24-000075`'s primary Form 4 already existing with different content. Fail-closed guard working as designed; open question is why the content differs and whether one conflicting accession should abort the whole CIK resync.
