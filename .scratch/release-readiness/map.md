...
- [Implement artifact-fetch concurrency](issues/77-implement-artifact-fetch-concurrency.md) — open: implements pipeline-throughput-architecture ticket 03's decision. `ThreadPoolExecutor` (bound 5) on the artifact-fetch loop, DB writes serialized, full 5-part test plan specified. Not yet implemented.
