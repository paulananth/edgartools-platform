...
- [Implement cross-command SEC-fetch lease](issues/80-implement-cross-command-sec-fetch-lease.md) — open: implements pipeline-throughput-architecture ticket 09's decision. Real overlap confirmed (bootstrap + daily-incremental, 4.16h, 2026-07-30) — a shared pipeline_run_lease under a new lease name, acquired by all 5 SEC-fetching commands. Not yet implemented.
