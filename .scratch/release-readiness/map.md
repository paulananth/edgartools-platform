...
10. [Backfill Apple's 494 missing bronze objects](issues/90-backfill-apple-494-missing-bronze-objects.md) — open, split from ticket 88.
11. [Scan other CIKs for the same missing-bronze-object pattern](issues/91-scan-other-ciks-for-missing-bronze-objects.md) — open, split from ticket 88.
