...
- **ERDP-04 (transcript MVP) not yet started:** spec locked (`specs/ERDP-04-transcript-mvp.md`), pilot sources locked (above), REQUIREMENTS.md checklist fully unchecked. No open decision blocks it — next work here is direct implementation, not a wayfinder ticket.
