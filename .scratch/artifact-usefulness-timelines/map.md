...
- [Lock 13F agent lookback window](issues/08-lock-thirteenf-agent-window.md) — Agent 13F: **`[max(W−3y, 2013-05-20), W]`**; full 2013→W archive **not** in first agent GO freeze (Explore backfill only).
