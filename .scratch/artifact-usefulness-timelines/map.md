...
- [Lock proxy agent lookback window](issues/10-lock-proxy-agent-window.md) — Agent proxy: originally `[W−5y, W]`, narrowed to **`[W−1y, W]`** (2026-07-23); baseline = latest in band; **no** pre-window baseline exception.
