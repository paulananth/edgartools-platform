...
- [ ] **Phase 2: Snowflake Graph Sync Contract** - adapt `edgar-warehouse mdm sync-graph` to materialize MDM graph state into Snowflake graph-ready node and edge tables/views (1/3 plans complete)
...
| 2. Snowflake Graph Sync Contract | v1.3 Neo4j Snowflake Native App Migration | 1/3 | In progress | - |
