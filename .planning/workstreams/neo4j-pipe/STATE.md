...
status: executing
last_updated: "2026-05-17T20:44:27Z"
...
Phase: 6 of 7 (Relationship Derivation Coverage)
...
|-------|------|--------------|--------|
| 5 — Source To MDM Load Path | Existing silver data can populate MDM entities without loader overlap | PIPE-01, PIPE-02, PIPE-03, ISO-01, ISO-02 | Complete |
| 6 — Relationship Derivation Coverage | Graph relationships are fully derived into MDM rows | REL-01, REL-02, REL-03, REL-04 | Complete |
...
- Plan 06-01: 5-tuple skip counters (D-02) added to all 6 relationship derivers; summary dict backward-compat maintained via skipped == sum(4 sub-counters).
- Plan 06-01: D-03 stderr events (mdm_relationship_skip JSON-lines) emitted only by IS_INSIDER and HOLDS — entity-only derivers do not emit events.
- Plan 06-01: fixture_world extended with MdmFund + MdmSecurity; test_returned_count_matches_inserts updated 4->6 (Rule 1 auto-fix — plan missed this pre-existing test).
- Plan 06-01: All 6 relationship types now covered by integration tests including idempotency (D-04).
