...
VIEWS: list[tuple[str, str, str]] = [
    ...
    ("EDGARTOOLS_DASHBOARD", "company360.insiders", "Company 360 / Insiders"),
    ("EDGARTOOLS_DASHBOARD", "company360.earnings", "Company 360 / Earnings"),
    ("EDGARTOOLS_DASHBOARD", "company360.executive_pay", "Company 360 / Executive pay"),
    ("EDGARTOOLS_DASHBOARD", "company360.accounting_flags", "Company 360 / Accounting flags"),
    ("EDGARTOOLS_DASHBOARD", "company360.institutional_holders", "Company 360 / Institutional holders"),
    ("EDGARTOOLS_DASHBOARD", "company360.relationships", "Company 360 / Relationships"),
    ("EDGARTOOLS_DASHBOARD", "fundamentals.screen", "Fundamentals Screener / Results"),
    ("EDGARTOOLS_DASHBOARD", "insider_watch.screen", "Insider Watch / Results"),
    ("EDGARTOOLS_DASHBOARD", "adv.explorer", "ADV Adviser and Fund Explorer"),
    ("EDGARTOOLS_DASHBOARD", "freshness.strip", "Dashboard / Freshness strip"),
