...
--
-- Originally generated by infra/scripts/generate_silver_landing_ddl.py, a
-- DuckDB-introspection-based generator (reflecting
-- edgar_warehouse.silver_store._DDL via an in-memory DuckDB connection, used
-- purely as an ephemeral SQL-parsing engine -- never a live production
-- dependency). DuckDB Retirement Cutover Ticket 07 deleted that generator
