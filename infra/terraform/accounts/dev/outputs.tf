...
output "mdm_postgres_dsn_secret_arn" {
  description = "Dev empty Secrets Manager container ARN for the operator-populated Snowflake Postgres MDM DSN."
  value       = module.runtime.mdm_postgres_dsn_secret_arn
}

output "bookkeeping_postgres_dsn_secret_arn" {
  description = "Dev empty Secrets Manager container ARN for the operator-populated bookkeeping store Postgres DSN."
...
output "mdm_snowflake_secret_arn" {
  description = "Dev empty Secrets Manager container ARN for operator-populated MDM Snowflake connection details."
